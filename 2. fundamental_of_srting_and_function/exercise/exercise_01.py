...
# Make sure to use the proper keyword argument to seperate the values.
# Don't cheat by manually copying and pasting the string.
print("a", "b", "c", sep=" ** ")


# Help me out! When I print the two lines blow, they are
# seperated by a line break. what's peanut butter without
# jelly? NOTHING! Fix the code to ensure the second
# line picks up wherr the first line concludes. Your
